		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("orangecloud_s3_bucket.bucket"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("orangecloud_s3_bucket.test"),
					resource.TestMatchResourceAttr(
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("orangecloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "acceleration_status", "Enabled"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("orangecloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "acceleration_status", "Suspended"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAWSS3BucketPolicy(
						"orangecloud_s3_bucket.bucket", testAccAWSS3BucketPolicy(rInt)),
				),
			},
			{
				Config: testAccAWSS3BucketConfig(rInt),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAWSS3BucketWebsite(
						"orangecloud_s3_bucket.bucket", "", "", "", ""),
					testAccCheckAWSS3BucketWebsiteRoutingRules("orangecloud_s3_bucket.bucket", nil),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "website_endpoint", ""),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("orangecloud_s3_bucket.bucket"),
					testAccCheckAWSS3DestroyBucket("orangecloud_s3_bucket.bucket"),
				),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					/*resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.transition.2000431762.date", ""),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.transition.2000431762.days", "30"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.transition.2000431762.storage_class", "STANDARD_IA"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.transition.6450812.date", ""),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.transition.6450812.days", "60"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.transition.6450812.storage_class", "GLACIER"), */
					resource.TestCheckResourceAttr(
					...
					/*resource.TestCheckResourceAttr(
					"orangecloud_s3_bucket.bucket", "lifecycle_rule.2.transition.460947558.days", "0"), */
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.3.id", "id4"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.3.prefix", "path4/"),
					/*resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.3.tags.tagKey", "tagValue"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.3.tags.terraform", "hashicorp"), */
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					/*resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.1377917700.days", "30"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.1377917700.storage_class", "STANDARD_IA"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.2528035817.days", "60"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.2528035817.storage_class", "GLACIER"), */
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.1.id", "id2"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.1.prefix", "path2/"),
					...
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.2.prefix", "path3/"),
					/* resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.2.noncurrent_version_transition.3732708140.days", "0"),
					resource.TestCheckResourceAttr(
						"orangecloud_s3_bucket.bucket", "lifecycle_rule.2.noncurrent_version_transition.3732708140.storage_class", "GLACIER"), */
				),
			},
			{
				Config: testAccAWSS3BucketConfig(rInt),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExistsWithProviders("orangecloud_s3_bucket.bucket", &providers),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExistsWithProviders("orangecloud_s3_bucket.bucket", &providers),
					resource.TestCheckResourceAttr("orangecloud_s3_bucket.bucket", "replication_configuration.#", "1"),
					resource.TestCheckResourceAttr("orangecloud_s3_bucket.bucket", "replication_configuration.0.rules.#", "1"),
					resource.TestCheckResourceAttr("orangecloud_s3_bucket.bucket", "replication_configuration.0.rules.2229345141.id", "foobar"),
					resource.TestCheckResourceAttr("orangecloud_s3_bucket.bucket", "replication_configuration.0.rules.2229345141.prefix", "foo"),
					resource.TestCheckResourceAttr("orangecloud_s3_bucket.bucket", "replication_configuration.0.rules.2229345141.status", s3.ReplicationRuleStatusEnabled),
				),
			},
		},
	})
...
// FAIL provider "orangecloud" is not available
...
func testAccAWSS3MultiBucketConfigWithTags(randInt int) string {
	t := template.Must(template.New("t1").
		Parse(`
resource "orangecloud_s3_bucket" "bucket1" {
...
resource "orangecloud_s3_bucket" "bucket2" {
...
resource "orangecloud_s3_bucket" "bucket3" {
...
resource "orangecloud_s3_bucket" "bucket4" {
...
resource "orangecloud_s3_bucket" "bucket5" {
...
resource "orangecloud_s3_bucket" "bucket6" {
...
resource "orangecloud_iam_role" "role" {
...
resource "orangecloud_s3_bucket" "destination" {
    provider = "orangecloud.reg2"
...
resource "orangecloud_s3_bucket" "bucket" {
    ...
    replication_configuration {
        role = "${orangecloud_iam_role.role.arn}"
        rules {
            id     = "foobar"
            prefix = "foo"
            status = "Enabled"
            ...
            destination {
                bucket        = "${orangecloud_s3_bucket.destination.arn}"
