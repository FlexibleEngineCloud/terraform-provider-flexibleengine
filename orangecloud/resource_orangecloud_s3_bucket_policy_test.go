		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAWSS3BucketHasPolicy("orangecloud_s3_bucket.bucket", expectedPolicyText),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("orangecloud_s3_bucket.bucket"),
					testAccCheckAWSS3BucketHasPolicy("orangecloud_s3_bucket.bucket", expectedPolicyText1),
				),
			},

			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("orangecloud_s3_bucket.bucket"),
					testAccCheckAWSS3BucketHasPolicy("orangecloud_s3_bucket.bucket", expectedPolicyText2),
				),
			},
		},
	})
