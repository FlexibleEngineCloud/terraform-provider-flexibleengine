...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"orangecloud_compute_servergroup_v2":          resourceComputeServerGroupV2(),
			"orangecloud_compute_floatingip_v2":           resourceComputeFloatingIPV2(),
			"orangecloud_compute_floatingip_associate_v2": resourceComputeFloatingIPAssociateV2(),
			"orangecloud_compute_volume_attach_v2":        resourceComputeVolumeAttachV2(),
			"orangecloud_dns_recordset_v2":                resourceDNSRecordSetV2(),
			"orangecloud_dns_zone_v2":                     resourceDNSZoneV2(),
			...
			"orangecloud_lb_pool_v2":                      resourcePoolV2(),
			"orangecloud_lb_member_v2":                    resourceMemberV2(),
			"orangecloud_lb_monitor_v2":                   resourceMonitorV2(),
			"orangecloud_networking_network_v2":           resourceNetworkingNetworkV2(),
			"orangecloud_networking_subnet_v2":            resourceNetworkingSubnetV2(),
			"orangecloud_networking_floatingip_v2":        resourceNetworkingFloatingIPV2(),
			"orangecloud_networking_port_v2":              resourceNetworkingPortV2(),
			"orangecloud_networking_router_v2":            resourceNetworkingRouterV2(),
			"orangecloud_networking_router_interface_v2":  resourceNetworkingRouterInterfaceV2(),
