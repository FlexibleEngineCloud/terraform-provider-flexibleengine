		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVBSBackupV2DataSourceID("data.flexibleengine_vbs_backup_v2.backups"),
					resource.TestCheckResourceAttr("data.flexibleengine_vbs_backup_v2.backups", "name", "vbs-backup"),
					resource.TestCheckResourceAttr("data.flexibleengine_vbs_backup_v2.backups", "description", "Backup_Demo"),
				),
			},
		},
	})
