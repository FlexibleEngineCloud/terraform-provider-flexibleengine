...
func TestAccDcsBackup_basic(t *testing.T) {
	...
	instanceName := acceptance.RandomAccResourceName()
	rName := "flexibleengine_dcs_backup.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDcsBackup_basic(name, instanceName),
...
func testDcsBackup_basic(name string, instanceName string) string {
	return fmt.Sprintf(`
%s

resource "flexibleengine_dcs_backup" "test" {
...
}`, testBaseNetwork(name), instanceName)
}
