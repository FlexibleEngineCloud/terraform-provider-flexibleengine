		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2KeypairExists("flexibleengine_compute_keypair_v2.orange_acctest_kp", &keypair),
				),
			},
		},
	})
...
resource "flexibleengine_compute_keypair_v2" "orange_acctest_kp" {
  name = "orange_acctest_kp"
