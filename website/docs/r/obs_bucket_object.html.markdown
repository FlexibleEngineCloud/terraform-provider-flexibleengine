...
page_title: "FlexibleEngine: flexibleengine_obs_bucket_object"
sidebar_current: "docs-flexibleengine-resource-obs-bucket-object"
description: |-
  Provides an OBS bucket object resource within FlexibleEngine.
---
