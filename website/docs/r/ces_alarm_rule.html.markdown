...
page_title: "FlexibleEngine: flexibleengine_ces_alarmrule"
sidebar_current: "docs-flexibleengine-resource-ces-alarmrule"
description: |-
  Manages an alarm rule resource within flexible engine.
---
