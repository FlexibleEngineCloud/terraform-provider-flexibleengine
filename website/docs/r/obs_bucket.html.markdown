...
page_title: "FlexibleEngine: flexibleengine_obs_bucket"
sidebar_current: "docs-flexibleengine-resource-obs-bucket"
description: |-
  Provides an OBS bucket resource within FlexibleEngine.
---
