---
layout: "orangecloud"
page_title: "OrangeCloud: orangecloud_fw_rule_v2"
sidebar_current: "docs-orangecloud-resource-fw-rule-v1"
description: |-
  Manages a v1 firewall group rule resource within OrangeCloud.
---

# orangecloud\_fw\_rule_v2

Manages a v2 firewall rule resource within OrangeCloud.
...
```
$ terraform import orangecloud_fw_rule_v2.rule_1 8dbc0c28-e49c-463f-b712-5c5d1bbac327
```
