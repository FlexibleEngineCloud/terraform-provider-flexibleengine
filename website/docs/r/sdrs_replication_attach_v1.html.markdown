...
page_title: "FlexibleEngine: flexibleengine_sdrs_replication_attach_v1"
sidebar_current: "docs-flexibleengine-resource-sdrs-replication-attach-v1"
description: |-
  Manages a V1 SDRS replication attach resource within FlexibleEngine.
---
