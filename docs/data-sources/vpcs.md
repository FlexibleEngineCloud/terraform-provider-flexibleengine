...
output "vpc_ids" {
  value = data.flexibleengine_vpcs.vpc.vpcs[*].id
}
```
...
* `vpcs` - Indicates a list of all VPCs found. The [vpcs](#vpcs) Structure is documented below.
